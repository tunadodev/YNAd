...
public class YNMAdsCallbacksMax {
    private String format = "";

    private YNMAirBridge.AppData appData;
    private double loadStartTime; // Field to track the start time

    public YNMAdsCallbacksMax() {
        appData = new YNMAirBridge.AppData();
    }

    public YNMAdsCallbacksMax(YNMAirBridge.AppData appData) {
        this.appData = appData;
    }

    public YNMAdsCallbacksMax(YNMAirBridge.AppData appData, String format) {
        this.format = format;
        this.appData = appData;
    }
