...
import com.ads.nomyek.ads.wrapper.StatusAd;
...
public class YNAdPlacer {
    ...
    public YNAdPlacer(YNAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
                ...
                holder.itemView.post(() -> {
                    ...
                    Admob.getInstance().loadNativeAd(activity, settings.getAdUnitId(), new AdCallback() {
                        ...
                        public void onUnifiedNativeAdLoaded(@NonNull NativeAd unifiedNativeAd) {
                            ...
                            unifiedNativeAd.setOnPaidEventListener(new OnPaidEventListener() {
                                ...
                                public void onPaidEvent(@NonNull AdValue adValue) {
                                    YNAdPlacer.this.onAdRevenuePaid(new ApAdValue(adValue));
                                }
                            });

                            YNAdPlacer.this.onAdLoaded(pos);
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            YNAdPlacer.this.onAdClicked();
                        }

                        @Override
                        public void onAdImpression() {
                            super.onAdImpression();
                            YNAdPlacer.this.onAdImpression();
                        }
                    }, null);
                });
            }
