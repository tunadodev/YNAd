...
import com.ads.nomyek.dialog.ResumeLoadingDialog;
                    ...
                    public void onAdLoaded(AppOpenAd ad) {
                        ...
                        if (!isSplash) {
                            ...
                            AppOpenManager.this.appResumeAd.setOnPaidEventListener(adValue -> {
                                YNLogEventManager.logPaidAdImpression(myApplication.getApplicationContext(),
                                        adValue,
                                        ad.getAdUnitId(),
                                        ad.getResponseInfo()
                    ...
                    splashAd.setFullScreenContentCallback(
                            new FullScreenContentCallback() {
                                ...
                                public void onAdClicked() {
                                    super.onAdClicked();
                                    if (currentActivity != null) {
                                        YNLogEventManager.logClickAdsEvent(currentActivity, splashAdId);
                                        if (fullScreenContentCallback != null) {
            ...
            if (appResumeAd != null) {
                appResumeAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdClicked() {
                        super.onAdClicked();
                        if (currentActivity != null) {
                            YNLogEventManager.logClickAdsEvent(currentActivity, appResumeAdId);
                            if (fullScreenContentCallback != null) {
                                fullScreenContentCallback.onAdClicked();
                            }
                        }
                ...
                new AppOpenAd.AppOpenAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull AppOpenAd appOpenAd) {
                        ...
                        appOpenAd.setOnPaidEventListener(adValue -> {
                            ...
                            YNLogEventManager.logPaidAdjustWithToken(adValue, appOpenAd.getAdUnitId(), YNAdConfig.ADJUST_TOKEN_TIKTOK);
                        });
                                    ...
                                    timerListenInter = new CountDownTimer(time, 1000) {
                                        ...
                                        public void onTick(long l) {
                                            if (statusInter == Type_Load_Success && !isAppOpenShowed) {
                                                isAppOpenShowed = true;
                                                Admob.getInstance().onShowSplash(activity, adListener, splashAdInter, YNAdConfig.ADJUST_TOKEN_TIKTOK);
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            YNLogEventManager.logPaidAdImpression(activity,
                                    adValue,
                                    interstitialAd.getAdUnitId(),
                                    interstitialAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);

                            YNLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), YNAdConfig.ADJUST_TOKEN_TIKTOK);
                        });
        ...
        new Handler().postDelayed(() -> {
            splashAd.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            YNLogEventManager.logClickAdsEvent(context, splashAdId);
