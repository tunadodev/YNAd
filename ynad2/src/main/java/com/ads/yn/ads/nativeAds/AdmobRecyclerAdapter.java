...
public class AdmobRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final YNAdPlacerSettings settings;

    private RecyclerView.Adapter adapterOriginal;
    private Activity activity;
    private YNAdPlacer adPlacer;
    private AdapterDataObserver adapterDataObserver = new AdapterDataObserver();

    public AdmobRecyclerAdapter(YNAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
        this.adapterOriginal = adapterOriginal;
        this.registerAdapterDataObserver(adapterDataObserver);
        this.activity = activity;
        this.settings = settings;
        adPlacer = new YNAdPlacer(settings, adapterOriginal, activity);
    }
