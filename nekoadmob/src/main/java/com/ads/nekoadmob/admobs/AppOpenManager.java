                            ...
                            new FullScreenContentCallback() {
                                ...
                                public void onAdClicked() {
                                    ...
                                    if (currentActivity != null) {
                                        YNMLogEventManager.logClickAdsEvent(currentActivity, splashAdId);
            ...
            if (appResumeAd != null) {
                appResumeAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdClicked() {
                        super.onAdClicked();
                        if (currentActivity != null) {
                            YNMLogEventManager.logClickAdsEvent(currentActivity, appResumeAdId);
                            if (fullScreenContentCallback != null) {
                                fullScreenContentCallback.onAdClicked();
                            }
                        }
...
//            }, 1000);
    ...
    public void loadSplashOpenHighFloor(Class splashActivity, Activity activity, String idOpenHigh, String idOpenMedium, String idOpenAll, int timeOutOpen, AdsCallback adListener) {
    ...
    public void loadAdOpenSplash2id(Class splashActivity, Activity activity, String idOpenHigh, String idOpenAll, int timeOutOpen, AdsCallback adListener) {
        statusHigh = Type_Loading;
        statusAll = Type_Loading;
        isAppOpenShowed = false;
    ...
    public void onCheckShowAppOpenSplashWhenFail(AppCompatActivity activity, AdsCallback callback, int timeDelay) {
        ...
        new Handler().postDelayed(() -> {
            splashAd.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            YNMLogEventManager.logClickAdsEvent(context, splashAdId);
