package com.ads.nomyek_admob.ads_components.ads_native;
...
public class AdmobRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final YNMAdPlacerSettings settings;

    private RecyclerView.Adapter adapterOriginal;
    private Activity activity;
    private YNMAdPlacer adPlacer;
    private AdapterDataObserver adapterDataObserver = new AdapterDataObserver();

    public AdmobRecyclerAdapter(YNMAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
        this.adapterOriginal = adapterOriginal;
        this.registerAdapterDataObserver(adapterDataObserver);
        this.activity = activity;
        this.settings = settings;
        adPlacer = new YNMAdPlacer(settings, adapterOriginal, activity);
    }
    ...
    private class YNMViewHolder extends RecyclerView.ViewHolder {
        public YNMViewHolder(@NonNull View itemView) {
            super(itemView);
        }
